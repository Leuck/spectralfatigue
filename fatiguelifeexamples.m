...
teste1.t=linspace(0,20,20*1300)';
teste1.ext=277.92/2*sin(2*pi*5*teste.t);
teste2.t=linspace(0,20,20*1300)';
...
%% Chamadas de funcao
for criteria = [1 2 3]
    T(1) = spectralfatigue(teste1,sn,criteria,pdf,1); % 5Hz, 277.92MPa -> 111h
    T(2) = spectralfatigue(teste2,sn,criteria,pdf,0); % 5Hz, 253.216MPa -> 333h
    T(3) = spectralfatigue(sinal2,sn,criteria,pdf,0); % rainflow --> 1152h
